...
local theme                                     = {}
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/ghost"
...
theme.bg_focus                                  = "#001717"
theme.bg_urgent                                 = "#000000"
theme.fg_normal                                 = "#00adad"
theme.fg_focus                                  = "#22adad"
theme.fg_urgent                                 = "#af1d18"
theme.fg_minimize                               = "#0f6767"
theme.border_width                              = 2
theme.border_normal                             = "#1c2022"
theme.border_focus                              = "#22adad"
theme.border_marked                             = "#3ca4d8"
theme.menu_border_width                         = 0
theme.menu_width                                = 140
theme.menu_submenu_icon                         = theme.confdir .. "/icons/submenu.png"
theme.menu_fg_normal                            = "#22adad"
theme.menu_fg_focus                             = "#000000"
theme.menu_bg_normal                            = "#000000"
theme.menu_bg_focus                             = "#22adad"
...
local cpu = lain.widget.cpu({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#22adad", cpu_now.usage .. "% "))
    end
})
...
local temp = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#22adad", coretemp_now .. "°C "))
    end
})
...
theme.volume = lain.widget.alsa({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#22adad", volume_now.level .. "% "))
    end
})
...
local netupinfo = lain.widget.net({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#22adad", net_now.sent .. " "))
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#22adad", mem_now.used .. "M "))
    end
})
